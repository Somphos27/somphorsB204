...
SECRET_KEY = os.environ.get('DJANGO_SECRET_KEY', 'django-insecure-4kqawvy$b^$$y&y45rs#y!p50k0xjsye3@#w=hs@ziijjll828')
...
ALLOWED_HOSTS = [
    'somphosphea.pythonanywhere.com', 
    '2026b204.pythonanywhere.com', 
    'localhost', 
    '127.0.0.1'
]
#ALLOWED_HOSTS = []
